...
def parse_arguments():
    ...
    parser.add_argument("--scenario", choices=["cobra-scenario-1", "cobra-scenario-2", "cobra-scenario-3", "cobra-scenario-4", "cobra-scenario-5", "cobra-scenario-6", "cobra-scenario-7", "cobra-scenario-8"], default="cobra-scenario-1", help="Scenario selection")
